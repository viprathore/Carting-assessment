  ...
  return (
                ...
                >
                  {loading ? (
                    ...
                    <div className='flex items-center justify-center'>
                      ...
                      {items.length > 1 ? 'Buy All' : 'Buy Now'}
                    </div>
                  )}
                </button>
    ...
    {showModal && (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
        <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl transform transition-all scale-100 animate-fadeIn">
          ...
          <div className="px-6 py-4 border-t flex gap-3 justify-end">
            <button
              ...
              className="px-5 py-2.5 rounded-xl font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 transition"
            >
              No, Cancel
            </button>
            ...
            <button
              ...
              className="px-6 py-2.5 rounded-xl font-semibold text-white bg-gradient-to-r from-green-500 to-teal-600 hover:from-green-600 hover:to-teal-700 transition shadow-md hover:shadow-lg"
            >
              Yes, Buy ALL
            </button>
          </div>
